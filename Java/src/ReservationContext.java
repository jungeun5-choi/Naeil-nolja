...
//        reservation1.add(new Reservation(roomItme1, "서예린", "010-1234-1234", reservation.getDate(), reservation.getReservationNumber()));
//        reservationNumberMap.put(number1, reservation1);
//
//        UUID number2 = reservation.setReservationNumber(UUID.randomUUID());
//        reservation2.add(new Reservation(roomItme2, "홍길동", "010-5481-8618", reservation.getDate(), reservation.getReservationNumber()));
...
//        reservation3.add(new Reservation(roomItme3, "김가나", "010-1361-5489", reservation.getDate(), reservation.getReservationNumber()));
//        reservationNumberMap.put(number3, reservation3);
//
//        UUID number4 = reservation.setReservationNumber(UUID.randomUUID());
//        reservation.setReservationNumber(UUID.randomUUID());
//        reservation4.add(new Reservation(roomItem4, "김가나", "010-1361-5489", reservation.getDate(), reservation.getReservationNumber()));
//        reservationNumberMap.put(number4, reservation4);
//
//        UUID number5 = reservation.setReservationNumber(UUID.randomUUID());
//        reservation.setReservationNumber(UUID.randomUUID());
//        reservation5.add(new Reservation(roomItem5, "김가나", "010-1361-5489", reservation.getDate(), reservation.getReservationNumber()));
